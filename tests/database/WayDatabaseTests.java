...
public class WayDatabaseTests {
    ...
    void GetWayTest() {
        // act
        Way way = wayDatabase.GetEntity(firstWay.getId());
    ...
    void GetAllWaysTest() {
        // act
        ArrayList<Way> ways = wayDatabase.GetTable();
    ...
    void InsertWayTest() {
        ...
        // act
        Way insertedWay = wayDatabase.Insert(newWay);

        // assert
        assertNotNull(insertedWay);

        Way way = wayDatabase.GetEntity(insertedWay.getId());
        assertNotNull(way);
    ...
    void UpdateWayTest() {
        ...
        // act
        Way updatedWay = wayDatabase.Update(firstWay);
        ...
        Way way = wayDatabase.GetEntity(updatedWay.getId());
        assertNotNull(way);
        assertEquals(firstWay.Name, way.Name);
        assertEquals(firstWay.End, way.End);
        assertEquals(firstWay.Start, way.Start);
    ...
    void DeleteWayTest() {
        // act
        boolean deleted = wayDatabase.Delete(firstWay.getId());
